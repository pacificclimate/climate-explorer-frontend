/*******************************************************************
 * StreamflowDataController.js - controller component for exploring
 * streamflow data.
 * 
 * Receives a model, an experiment, metadata on all available 
 * streamflow datasets, and a list of one or more sets of coordinates
 * from its parent, StreamflowController. (Stations are selected
 * by the user on the map and handled by MapController.)
 * 
 * Queries the backend to retrieve flow information at the requested
 * stations, parses the information, and displays it on three viewer
 * components:
 *  
 * - a DataTable with statistics about each station 
 * - an annual cycle DataGraph with monthly, seasonal, and annual 
 *   streamflow resolution 
 * - a projected change DataGraph with each station displayed separately
 *******************************************************************/
